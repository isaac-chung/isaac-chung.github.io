...
* a python [script](https://github.com/isaac-chung/Predicting-Used-Car-Prices-in-Toronto/blob/master/webscraper.py) that contains a template for web scraping
* a [jupyter notebook](https://github.com/isaac-chung/Predicting-Used-Car-Prices-in-Toronto/blob/master/Used-car-demo.ipynb) containing the annotated end-to-end data science demo
